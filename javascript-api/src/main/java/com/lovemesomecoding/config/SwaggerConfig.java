...
public class SwaggerConfig {
    ...
    private ApiInfo getApiInfo() {
        ...
        Contact contact = new Contact("Javascript", "http://folaukaveinga.org", "folaukaveinga@gmail.com");

        return new ApiInfoBuilder().title("Javascript Rest API").description("Javascript API").version("1.0.0").contact(contact).build();
    }
